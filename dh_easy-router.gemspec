...
Gem::Specification.new do |spec|
  spec.name          = "dh_easy-router"
  spec.version       = DhEasy::Router::VERSION
  spec.authors       = ["Eduardo Rosales"]
  spec.email         = ["eduardo@datahen.com"]

  spec.summary       = %q{DataHen Easy toolkit router module}
  spec.description   = %q{DataHen Easy toolkit router module allow an easier class integration, useful on advance implementations.}
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "https://github.com/DataHenOfficial/dh_easy-router"
